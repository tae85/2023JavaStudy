...
/*
부모클래스와 다른 패키지에 선언되었으므로 import 해야 한다. 단, 부모클래스는 반드시 public으로 
선언해야 한다. 만약 default로 선언하면 접근자체가 불가능하므로 import도 할 수 없게 된다.
 */
...
//		super.defaultMethod();
//		super.privateMethod();
		/* 이와 같이 직접 접근할 수 없는 메서드는 접근 가능한 멤버 메서드를 통해 간접 호출하면 된다. */
	}
}
