...
//	}
	...
	/*
	...을 통해 매개변수 param이 2개 이상의 인수를 받을 수 있는 것을 명시한다. 또한 메서드
	내에서는 배열로 반환되어 "매개변수명.length"와 같이 사용할 수 있다.
	 */
	
	static int getTotal(int ... param) { //(int param, String a, double ... param2) 스프레드방식?
		int total = 0;
	...
	public static void main(String[] args) {
		// 가변인자를 통해 메서드를 정의하였으므로 아래 모든 호출분장은 정상적으로 실행된다.
		...
		System.out.println("getTotal(매겨변수6개)호출:" + getTotal(10,20,30,40,50,60));
		
		/* 매개변수의 타입이 double이 포함되어 있으므로 호출할 수 없다. 만약 아래와 같이 실수를 모두 처리하려면
