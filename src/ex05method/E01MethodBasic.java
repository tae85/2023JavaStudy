...
public class E01MethodBasic  {
	...
	/*
	메서드2 : 반환값X, 매개변수X 형태
	=> 전달 받는 값 없이 이름을 입력받은 후 namePrint()를 호출한다.
	이와 같이 반환 값이 없는 경우에는 void를 명시해야한다.
	 */
	...
	/*
	메서드3 : 반환값X, 매개변수O 형태
	=> 문자열을 인수로 전달받아 단순히 출력만한다. 반환값이 없는 경우에는
	...
	public static void main(String[] args) {
		...
		매개변수가 있다면 개수만큼 포함한다. 개수가 다르거나 타입이 틀리면 에러가 발생한다.
		 */
