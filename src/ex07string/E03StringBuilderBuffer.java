...
/*
StringBuffer클래스
: String클래스는 기존 문자열에 새로운 문자열을 추가하면 새롭게 생성된 메모리에
문자열을 저장한다. 기존 메모리가 소멸되고 새로운 메모리가 생성되는 낭비를 막기 위해,
...
public class E03StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		/* StringBuffer 클래스는 문자열을 저장하기 위해 기본 메모리를 16으로
		할당한다. 차후 저장공간이 부족하면 자동으로 메모리를 확장한다. */
