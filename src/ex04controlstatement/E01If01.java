...
if문 형식1
	...
	-즉 결과값이 boolean타입으로 true/false를 반환해야 한다.
...
//		}
		...
		/*
		if(조건식); => 세미콜론은 문장의 끝을 나타내므로 조건에 상관없이 중괄호에 있는 문장이
			실행된다. 따라서 사용에 주의해야한다.
		 */
		if(num%2 != 0);
		{
		...
		/*
		아스키코드를 알고 있을 때의 구현방법. 문자0과 9가 아스키코드 48, 57에 해당하므로 
		구간내에 있는지 확인하면 된다.
		 */
		...
		아스키코드로 변화되므로 아래와 같은 조건으로도 확인할 수 있다.
		 */
