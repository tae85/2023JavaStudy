...
클래스 선언시 class 예약어를 사용한다. 클래스명의 첫글자는 반드시 대문자를 사용해야 
한다. 또한 public 접근지정자는 하나의 Java파일에 한번만 사용할 수 있다.
 */
class Person {
	/*
	...
	/*
	멤버메서드 : 클래스에서 객체의 동작(행위)를 표현한다. 클래스 외부에서 호출할 때는
...
public class E01PersonMain {
	...
	public static void main(String[] args) {
		...
		//객체 생성 직후 참조변수를 사용하지 않아도, 호출할 수 있다.
		new Person().eat();
		new Person().sleep();
	}
