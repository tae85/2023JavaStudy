...
class MyString implements Comparable<MyString> {
	...
	/*
	TreeSet<T>에 인스턴스를 저장할 때 정렬을 위해 compareTo()를 오버라이딩 한다. 정렬의 기준은 
	단순히 "가나다라"와 같은 순서가 될 수도 있고, 문자열의 길이에 따른 정렬이 될 수도 있다. 아래의 
	코드는 오름차순(작은 것 -> 큰 것) 정렬일 때 사용한다. 1과 -1의 위치가 바뀌면 내림차순이 된다.
	 */
	@Override
