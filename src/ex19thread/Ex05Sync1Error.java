...
class SumMulti {
	...
	/*
	쓰레드의 run()에서 호출하는 메서드로 매개변수로 전달되는 정수를 누적해서 더해준다. 여기서는 2개의 쓰레드가
	5000번씩 각각 호출하게 된다.
	 */
...
class MultiAdderThread extends Thread {
	...
	/*
	쓰레드를 통해 반복적으로 공유객체인 sumInst의 addNum()을 호출한다. 이 경우 동기화 처리가 되지 않아
...
public class Ex05Sync1Error {
	...
	public static void main(String[] args) {
		/*
		하나의 객체를 2개의 쓰레드가 공유해서 사용하는 형태로 동작시킨다. 각각의 쓰레드가 5000번씩 반복해서 호출하게 된다.
		 */
