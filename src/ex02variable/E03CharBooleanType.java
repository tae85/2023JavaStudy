...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		/*
		char형 : 하나의 문자를 저장할 수 이쓴 자료형으로 값을 저장할 때 '(single quotation)으로
			감싸서 표현한다. 만약 "(Double quotation)으로 감싸면 문자열로 인식하므로 String으로 
			선언해야 한다.
		 */
		char ch1 = '가';
...
//		char chStr = 가나다라;
		...
		유니코드 : 1byte로 표현할 수 없는 문자로 영문과 숫자를 제외한 모든 문자(한글, 한자 등)를 
			2byte로 표현한다. 보통 숫자가 크기 때문에 16진수로 표현한다.
		 */
		...
		/*
		&&(논리And) : 엠퍼샌드를 사용하고 양쪽 모두 참일 때만 참을 반환한다. 
			그 외에는 모두 거짓을 반환한다.
